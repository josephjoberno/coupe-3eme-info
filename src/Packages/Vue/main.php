...
if (isset($_POST['tirage'])) {
    ...
    header('Location:./presentation.php?tirage=true');
}
...
echo "<script>"."alert('prolongation')"."</script>"; 
...
if ($resultDemi2 = $resultD2->fetchObject()) echo ''; //creation de la variable resultDemi si la requete est true(il existe une quipeGagnante)
...
if ($resultDemi3 = $resultD3->fetchObject()) echo ''; //creation de la variable resultDemi si la requete est true(il existe une quipeGagnante)
